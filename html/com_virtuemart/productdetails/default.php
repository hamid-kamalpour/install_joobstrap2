...
<div class="productdetails-view">
 <?php
	...
	<div class="back-to-category">
    	<a style="margin-left:10px" href="<?php echo $catURL ?>" class="btn btn-info" title="<?php echo $categoryName ?>"><?php echo JText::sprintf('COM_VIRTUEMART_CATEGORY_BACK_TO',$categoryName) ?></a>
	</div>
	...
	?>
	    ...
	    echo str_replace("modal","vmmodal",$this->linkIcon($link . '&print=1', 'COM_VIRTUEMART_PRINT', 'printButton', 'show_printicon'));
	    echo str_replace("modal","vmmodal",$this->linkIcon($MailLink, 'COM_VIRTUEMART_EMAIL', 'emailButton', 'show_emailfriend'));
	    ?>
    	<div class="clear"></div>
        </div>
