...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" class="form-inline" role="form">
	<fieldset class="word"><label for="search-searchword"> <?php echo JText::_('COM_SEARCH_SEARCH_KEYWORD'); ?> </label>
		<div class="form-group">
			
			<div class="controls">
				<input type="text" name="searchword" id="search-searchword" size="30" maxlength="<?php echo $upper_limit; ?>" value="<?php echo $this->escape($this->origkeyword); ?>" 
				class="form-control pull-left" />
			</div>
		</div>
		<div class="form-actions form-group">
			<button name="Search" onclick="this.form.submit()" class="btn btn-primary button pull-left"><?php echo JText::_('COM_SEARCH_SEARCH');?></button>
		</div>
