    ...
    <?php if($this->params->get('responsiveBehavior') == 1) : ?>
			<style type="text/css">
					.inner_wrapper, .container {margin:0px auto;  width:<?php echo $this->params->get('maxWidth'); ?>px;max-width:<?php echo $this->params->get('maxWidth'); ?>px;min-width:<?php echo $this->params->get('maxWidth'); ?>px;}
			</style>
	<?php endif; ?>
	
	<?php if($this->params->get('responsiveBehavior') == 2) : ?>
			<style type="text/css">
					.inner_wrapper, .container {margin:0px auto; width:100%;max-width:<?php echo $this->params->get('maxWidth'); ?>px;min-width:<?php echo $this->params->get('minWidth'); ?>px;}
			</style>
	<?php endif; ?>
